                ...
                <div className="col-6">
                    <div className="card-1">
                        <div className="card-text">
                           <span> <h1>Move faster</h1></span>
                           <h1>with intuitive features</h1>
                           <h2 className="text">React UI tools</h2>
                          <span> <p>MUI offers a comprehensive suite of free UI tools to help you ship new features faster. Start with Material UI, our fully-loaded component library, or bring your own design system to our production-ready components</p></span>
                        </div>
                    </div>
                    ...
                    <div className="col-6">
                        <div className="card-2">
                            <div className="card-body">
                                ...
                                <h2 className="txt">Every component you need is</h2>
                                <h3 className="txt">ready for production</h3>
                                <p className="txt">Build at an accelerated pace without sacrificing flexibility or control.</p>
